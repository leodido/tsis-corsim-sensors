...
public:
    ...
    inline const CString   &getControlType() const
    {
        return m_str_control_type;
    }

    inline int              getCorsimId() const
    {
        return m_corsim_internal_id;
    }
    inline void             setCorsimId(int id)
    {
        m_corsim_internal_id = id;
    }
    ...
    inline int              getXLocation(void) const
    {
        return m_x_pos;
    }
    inline int              getYLocation(void) const
    {
        return m_y_pos;
    }
