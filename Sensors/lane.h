...
public:
    ...
    inline int                            getLeftMovePercent() const
    {
        return m_left_movement_pc;
    }
    inline void                           setLeftMovePercent(int percent)
    {
        m_left_movement_pc = percent;
    }
    inline int                            getThruMovePercent() const
    {
        return m_thru_movement_pc;
    }
    inline void                           setThruMovePercent(int percent)
    {
        m_thru_movement_pc = percent;
    }
    inline int                            getRightMovePercent() const
    {
        return m_right_movement_pc;
    }
    inline void                           setRightMovePercent(int percent)
    {
        m_right_movement_pc = percent;
    }
