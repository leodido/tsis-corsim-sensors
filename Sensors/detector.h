...
public:
    ...
    inline int                getCorsimId() const
    {
        return m_corsim_id;
    }
    inline void               setCorsimId(int corsim_id)
    {
        m_corsim_id = corsim_id;
    }

    inline CLink             *getLink() const
    {
        return m_link;
    }
    inline CLane             *getLane() const
    {
        return m_lane;
    }

    // constant attributes (type, lenght, distance)
    inline DetectorType       getType() const
    {
        return m_type;
    }
    ...
    inline int                getTimePeriodVolume(int tp) const
    {
        return m_tp_volume_list.at(tp);
    }
    inline void               setTimePeriodVolume(int volume)
    {
        m_tp_volume_list.push_back(volume);
    }
    inline std::vector<int>   getVolumes() const
    {
        return m_tp_volume_list;
    }

    // activation/deactivation
    inline float              getActivationTime() const
    {
        return m_activation_time;
    }
    inline void               setActivationTime(float time)
    {
        m_activation_time = time;
    }
    inline float              getDeactivationTime() const
    {
        return m_deactivation_time;
    }
    inline void               setDeactivationTime(float time)
    {
        m_deactivation_time = time;
    }

    void                      printTransitionList(void);
    std::vector<std::string>  getTransitions(void);

    inline CString            getLabel(void) const
    {
        return m_label;
    }
...
private:
    ...
    std::vector<int>          m_tp_volume_list;
    CString                   m_label;
};
