...
class CLink : public CObject
{
   public:
	  ...
	  inline int                            getCorsimId(void) { return m_corsim_id; }

	  inline int                            getUpNode(void) { return m_up_node->getId(); }
	  inline int                            getDnNode(void) { return m_dn_node->getId(); }
      inline int                            getThruNode(void) { return m_thru_node->getId(); }
	  inline int                            getLeftNode(void) { return m_left_node->getId(); }
      ...
      inline int                            getOpposingNodeId() const { return m_opposing_node_id; }
      inline void                           setOpposingNodeId(int node_id) { m_opposing_node_id = node_id; }
